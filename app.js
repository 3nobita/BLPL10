...
client.messages
    .create({
        body: 'Hello, this is a test message from Twilio!', // Add a message body
        from: '+13214138469', // Your Twilio phone number
        to: '+918851041909' // Replace with your recipient's phone number
    })
    .then(message => console.log('Message sent with SID:', message.sid))
    .catch(error => console.error('Error sending message:', error)); // No .done() needed
